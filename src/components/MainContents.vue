...
const feedList = [
  {
    icon: new URL('@/assets/img/icon_target_board.webp', import.meta.url).href,
    title: '이벤트 참여방법',
    description: '매일매일 AI 추천 피드를 확인해 주세요 \n 피드를 모두 확인하시면 피드런이 완성됩니다',
    image: new URL('@/assets/img/act-howto.webp', import.meta.url).href,
    buttonText: '피드를 좌우로 넘겨서 확인해주세요.',
  },
  {
    icon: new URL('@/assets/img/icon_book_mark.webp', import.meta.url).href,
    title: '이벤트 혜택안내',
    description: '피드런을 완료하신 고객님께 해외주식 \n (엔비디아, 테슬라, 애플 중)을 선물로 드려요',
    image: new URL('@/assets/img/act-reward.webp', import.meta.url).href,
  },
];
  ...
  <section class="content">
    <div class="content__container">
      <div class="content__title">
        <img src="@/assets/img/icon_calendar.webp" alt="feed-icon" />
        <h2>이벤트 안내</h2>
      </div>
    ...
    <div class="content__share">
      ...
      <div class="content__share-button">
        <button>
          <img src="@/assets/img/kakao.webp" alt="share-icon" />
        </button>
        <button>
          <img src="@/assets/img/share.webp" alt="share-icon" />
        </button>
      </div>
    </div>
